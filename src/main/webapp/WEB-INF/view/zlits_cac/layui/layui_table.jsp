...
<table class="layui-table" lay-data="{width:800, height: 300, url:'${pageContext.request.contextPath}/layui/examples/json/table/demo2.json', page: true, limit: 6}">
  <thead>
    <tr>
...
<table class="layui-table" lay-data="{url:'${pageContext.request.contextPath}/layui/examples/json/table/demo2.json', page: true, limit: 6}">
  <thead>
    <tr>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,height: 350
    ,url: '${pageContext.request.contextPath}/layui/examples/json/table/demo1.json'
    ,page: {
